...
let thirdString = `French Quotes`

console.log('Single quotes: ' + firstString)
console.log('Double quotes: ' + secondString)
console.log('French quotes: ' + thirdString)
...
console.log('typeof use for declared, constructed and object strings: ')
...
console.log('Print the character at index 10: ')
console.log(testString[10])
console.log('Print the character at index 10 using charAt(): ')
console.log(testString.charAt(10))
console.log('Print the index of the first occurrence of *: ')
console.log(testString.indexOf('*'))
console.log('Print the index of the last occurrence of "fun": ')
console.log(testString.indexOf('fun'))
console.log('Print the index of the last occurrence of *: ')
console.log(testString.lastIndexOf('*'))
console.log('Slice the string from index 10 to 16: ')
console.log(testString.slice(10,16))
console.log('Print the length of the string: ')
console.log(testString.length)
console.log('Print the string in uppercase: ')
console.log(testString.toUpperCase())
console.log('Print the split string: ')
console.log(splitedString)
console.log('Print the string with spaces: ')
